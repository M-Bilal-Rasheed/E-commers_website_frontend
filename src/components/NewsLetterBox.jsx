    ...
    <div className='text-center'>
      <p className='text-2xl font-medium text-gray-800'>Subscribe now & get 20% off</p>
       <p className='text-gray-400 mt-3'>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eos adipisci magni illum perferendis autem, eaque nobis, aliquam ut atque dignissimos asperiores earum tempore minus omnis. Perspiciaus blanditiis.
       </p>
